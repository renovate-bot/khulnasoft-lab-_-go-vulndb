...
import (
	...
	"github.com/khulnasoft-lab/go-vulndb/internal/cvelistrepo"
	...
	"github.com/khulnasoft-lab/go-vulndb/internal/worker/log"
	"github.com/khulnasoft-lab/go-vulndb/internal/worker/store"
...
func UpdateCVEsAtCommit(ctx context.Context, repoPath, commitHashString string, st store.Store, pkgsiteURL string, force bool) (err error) {
	...
	vulndb, err := gitrepo.Clone(ctx, "https://github.com/khulnasoft-lab/go-vulndb")
	if err != nil {
		return err
	}
...
See [doc/triage.md](https://github.com/khulnasoft-lab/go-vulndb/blob/master/doc/triage.md) for instructions on how to triage this report.
