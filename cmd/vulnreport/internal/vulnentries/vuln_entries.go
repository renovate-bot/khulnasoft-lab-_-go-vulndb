...
func Functions(pkgs []*packages.Package, m *report.Module) ([]*ssa.Function, error) {
	...
	// github.com/khulnasoft-lab/go-vulndb/vuln/internal/vulncheck/source.go:Source.
...
//
// It mimics github.com/khulnasoft-lab/go-vulndb/vuln/internal/vulncheck/source.go:vulnFuncs.
...
func vulnReachingEntries(cg *callgraph.Graph, sinks []*callgraph.Node, allEntries []*ssa.Function) []*callgraph.Node {
	...
	// github.com/khulnasoft-lab/go-vulndb/vuln/internal/vulncheck/source.go:callGraphSlice.
